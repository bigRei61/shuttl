        ...
        <div class="stats-shell">
            <div class="stats-overview">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                    ...
                    <div class="rating-pill">Player Rating: {{ number_format($user->rating_value ?? 1000, 0) }}</div>
                </div>
                ...
                <div class="stats-grid mt-4">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="value">{{ number_format($user->rating_value ?? 1000, 0) }}</div>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="history-list">
                            @foreach($recentMatches as $match)
                                <li class="history-item">
                                    ...
                                    <div class="text-end">
                                        <span class="badge {{ strtolower($match['result']) }}">{{ $match['result'] }}</span>
                                        <div class="muted" style="font-size:12px; margin-top:4px;">{{ $match['score'] }}</div>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
