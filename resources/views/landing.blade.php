            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 p-0">
                    <div class="feature-item set-bg" data-setbg="{{ asset('page-top-bg/1.png') }}">
                        <div class="fi-content text-white">
                            <h5>@guest<a href="{{ route('tournaments') }}">Tournaments</a>@else<a href="{{ route('events.index') }}">Tournaments</a>@endguest</h5>
    ...
    <footer class="footer-section">
        <div class="container">
            <ul class="footer-menu">
                ...
                <li><a href="{{ route('history') }}">Statistics</a></li>
                <li>@guest<a href="{{ route('tournaments') }}">Tournament</a>@else<a href="{{ route('events.index') }}">Tournament</a>@endguest</li>
            </ul>
